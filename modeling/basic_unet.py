...
class Down(nn.Sequential):
    ...
    def __init__(
        ...
        """
        super().__init__()
        max_pooling = Pool["MAX", spatial_dims](kernel_size=kernel_size)
...
class BasicUNet(nn.Module):
    def __init__(
        ...
        self.down_3 = Down(
            spatial_dims, fea[2], fea[3], act, norm, bias, dropout, kernel_size=(1, 2, 2)
        )
        self.down_4 = Down(
            spatial_dims, fea[3], fea[4], act, norm, bias, dropout, kernel_size=(1, 2, 2)
        )
